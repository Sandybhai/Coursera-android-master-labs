...
public class MainActivity extends Activity implements SelectionListener,
	...
	public void notifyDataRefreshed(String[] feeds) {
      //  Log.i("NEXTPARSE","parsing");
	    ...
	    Log.i("INSIDE NOTIFYDATA", "notify");
	...
	private void installFeedFragment(String tweetData) {
	   ...
	   Log.i("INSIDE INSTALL", e.toString());	
	}
	}	
	...
	private void parseJSON(String[] feeds) {
		...
		Log.i("IN JSON",Integer.toString(z) );
		for (int i = 0; i < JSONFeeds.length; i++) {
			...
			Log.i("PARSECREATE", Integer.toString(feeds.length));
		}
	}
}
