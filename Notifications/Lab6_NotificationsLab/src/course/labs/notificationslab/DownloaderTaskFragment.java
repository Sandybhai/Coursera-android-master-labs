...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.i("PACKAGENAME", mContext.getPackageName());
			...
			mContext.sendOrderedBroadcast(new Intent(
					...
					//		if (true || false) {
                            if(result!=MainActivity.IS_ALIVE){
                             ...
                             PendingIntent pint = PendingIntent.getBroadcast(mContext, 0, restartMainActivityIntent,
								...
								Notification.Builder notificationBuilder = new Notification.Builder(context).setContent(mContentView).setAutoCancel(true)
										.setContentIntent(pint).setSmallIcon(android.R.drawable.stat_sys_warning).setTicker("Download Successful");
